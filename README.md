...
| Vista móvil de Solicitudes (UX v2): leyenda de filtros + fila única, fechas colapsables y disponibles para todos los usuarios, KPIs 20% más compactos, buscador con botón ✕, selects y "Seleccionar todo" compactos, y fix del menú ⋮ que se recortaba (ahora se posiciona fixed y nunca se corta) | Agosto 2026 | `docs/feature-filtros-buscador-movil-solicitudes.md` |
