        ...
        _buildHTML: function() {
            ...
            return '' +
                ...
                '<div id="mm-sheet" class="mm-sheet" role="dialog" aria-label="Menú de navegación">' +
                    ...
                    '<div class="mm-header">' +
                        '<div class="mm-header-logo"><img src="/img/logo/logo-icon.svg" alt="Archivox" class="mm-header-title-img" /><span class="mm-header-logo-text">Archivox</span></div>' +
        ...
        return '' +
            ...
            '<aside id="drawer" class="drawer">' +
                '<div class="drawer-header">' +
                    '<div class="drawer-logo">' + (esPaginaAdmin() ? '<h2>🛡️ Admin</h2>' : '<div class="drawer-logo-wrap"><img src="/img/logo/logo-icon-blanco.svg" alt="Archivox" class="drawer-logo-img" /><span class="drawer-logo-text">Archivox</span></div>') + '</div>' +
