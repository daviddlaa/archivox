/*
    Página de importación móvil
    - Adaptación específica para UI móvil
    - Rutas de navegación /m
    - Reportes de subida en formato móvil
*/

// Lógica específica de la página de importar para móvil
const form = document.getElementById('formExcel');
const mensaje = document.getElementById('mensaje');
const inputArchivos = document.getElementById('excelFiles');
const btnSubir = document.querySelector('#formExcel button[type="submit"]');

if (!form || !mensaje || !inputArchivos || !btnSubir) {
    console.error('No se pudieron inicializar los elementos del formulario de importar');
} else {
    inputArchivos.addEventListener('change', () => {
        ...
        let html = `
            <div class="info">
                <strong>${inputArchivos.files.length}</strong>
    ...
    form.addEventListener('submit', async (e) => {
        ...
        for (const archivo of archivos) {
            formData.append('excelFiles', archivo);
        }
